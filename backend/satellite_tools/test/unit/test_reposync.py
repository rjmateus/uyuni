...
class RepoSyncTest(unittest.TestCase):
    ...
    def test_update_bugs(self):
        ...
        for bug in bugs:
            self.assertEqual(set(list(bug.keys())), set(['bug_id', 'href', 'summary']))
    ...
    def test_update_cves(self):
        ...
        self.assertEqual(set(cves), set(["CVE-1234-5678", "CVE-1234-123456"]))
    ...
    def test_update_cves_with_description(self):
        ...
        self.assertEqual(set(cves), set(["CVE-1234-567901", "CVE-1234-5678", "CVE-1234-1234"]))
    ...
    def test__url_with_repo_credentials(self):
        ...
        config = {
            'return_value.fetchone_dict.return_value': {
                "username": "user#1",
                "password": base64.encodebytes(password.encode())
            }
        }
        patcher = patch(
        ...
        with patcher as mock_prepare:
            self.assertEqual(
                ...
                'http://{0}:{1}@some.url'.format(username, password.encode()).encode()
            )
