...
CREATE UNIQUE INDEX suseWebEndpoint_endpoint_http_method_uq
    ON suseWebEndpoint (endpoint, http_method);
...
CREATE UNIQUE INDEX suseUserWebEndpoint_user_webendpoint_uq
    ON suseUserWebEndpoint (user_id, web_endpoint_id);
